  ...
  @initConfig
    ...
    jshint:
      app:
        ...
        src: ['<%= SRC_DIR %>/js/lib/phaser.min.js','<%= SRC_DIR %>/js/lib/phaser-screenshake.js','<%= SRC_DIR %>/js/load.js','<%= SRC_DIR %>/js/menu.js','<%= SRC_DIR %>/js/level1.js','<%= SRC_DIR %>/js/level2.js','<%= SRC_DIR %>/js/level3.js','<%= SRC_DIR %>/js/player.js','<%= SRC_DIR %>/js/game.js']


    uglify:
      dist:
        files:
          '<%= DST_FILE %>.min.js': ['<%= SRC_DIR %>/js/lib/phaser.min.js','<%= SRC_DIR %>/js/lib/phaser-screenshake.js','<%= SRC_DIR %>/js/load.js','<%= SRC_DIR %>/js/menu.js','<%= SRC_DIR %>/js/level1.js','<%= SRC_DIR %>/js/level2.js','<%= SRC_DIR %>/js/level3.js','<%= SRC_DIR %>/js/player.js','<%= SRC_DIR %>/js/game.js']
